...
namespace Captioneer.API.Migrations
{
    ...
    [Migration("20230510170507_Updated-Followers-SQLTable")]
    partial class UpdatedFollowersSQLTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.Follower", b =>
                {
                    ...
                    b.Property<DateTime>("FollowerCreatedAt")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("API.Entities.Follower", b =>
                {
                    b.HasOne("API.Entities.User", "UserFollowers")
                        .WithMany()
