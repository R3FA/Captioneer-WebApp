...
INSERT INTO `__efmigrationshistory` VALUES ('20221109235306_InitialMigration','6.0.11');
...
CREATE TABLE `comments` (
  ...
  CONSTRAINT `FK_Comments_Users_AdminID` FOREIGN KEY (`AdminID`) REFERENCES `users` (`ID`),
...
CREATE TABLE `subtitlemovies` (
  ...
  CONSTRAINT `FK_SubtitleMovies_Users_AdminID` FOREIGN KEY (`AdminID`) REFERENCES `users` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `subtitletvshows` (
  ...
  CONSTRAINT `FK_SubtitleTVShows_Users_AdminID` FOREIGN KEY (`AdminID`) REFERENCES `users` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  CONSTRAINT `FK_Users_Users_AdminID` FOREIGN KEY (`AdminID`) REFERENCES `users` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-11-10  0:56:48
